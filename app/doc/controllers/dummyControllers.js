...
myAppModule.
    ...
    controller('DummyGratuitousPermitController', ['$scope', 'dummyGratuitousPermitService', "$localStorage",
    ...
    controller('DummyGratuitousPermitController', function($scope, $quillService){
            ...
            $scope.n = {
                ...
                terms: '<h1>Hello</h1> <ul><li>the</li><li>quick</li><li>brown</li></ul>'
            }
