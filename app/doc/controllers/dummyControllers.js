...
myAppModule.
    ...
    controller('GratuitousPermitController', function ($scope, $quillService) {
        $scope.n = {
            permit_number: "2019-14",
            species_to_collect: "seahorse",
            purpose_of_collection: "Conduct of Field Research Involving Seahorse",
            application_type: "Individual",
            applicant: {
                last_name: "Nellas",
                first_name: "Angelie",
                middle_name: "C",
                full_name: "Angelie C. Nellas",
                employment: {
                    designation: "Senior Biologist",
                    agency_name: "Zoological Society of London-Philippines"
                },
                address: "London, UK",
                nationality: "British",
                degree: "Biology",
            ...
            paid_or_number: "859485",
            paid_date: "2019-09-09",
            line1: "WILDLIFE GRATUITOUS PERMIT (GP)",
            line2: "No.: 2019-14",
            line3: "Wildlife Gratuitous Permit for the Conduct of Field Research Involving Seahorse",
            line4: 'Pursuant to the provisions of PCSD Resolution No. 11-423 or PCSD Administrative ' +
            ...
            line5: "Ms. Angelie C. Nellas",
            line6: "Subject to the terms and conditions herein stated: ",
            line7: 'Non-compliance with any of the above conditions or the relevant provisions of PCSD Admin Order  No. 12 ' +
                ', series of 2011 shall be sufficient cause for the suspension or cancellation of this Permit and the imposition ' +
                'of appropriate penalty provided under the said Admin. Order.',
            line8: 'Issued this 14th day of May 2019 at Brgy. Sta. Monica, Puerto Princesa City, Palawan Philippines. ',
            line9: 'I, Ms. Angelie C. Nellas, holder of the foregoing permit, hereby certify that I have read and understood ' +
            ...
            line10: "Ms. Angelie C. Nellas",
            line11: "Signature over Printed Name",
            line12: "Date: May 19, 2019",
            line13: "PAID FEE: 160.00",
            line14: "Paid Under O.R. # 123456",
            line15: "Date: September 25, 2019",
            line16: "Not valid without PCSD official seal.",
            ...
            terms: {
                ops: [
                    { insert: "Data Gathering/Collection" },
                    { attributes: { list: "orderded" }, insert: "" },
        ...
        var preview_editor = $quillService.createInstance('#preview_editor', '');
        preview_editor.disable();
        $quillService.onEditorCreated = (quillEditor) => {
            quillEditor.on('text-change', (delta, oldDelta, source) => {
                $scope.n.terms = quillEditor.getContents();
                $scope.n.terms.push({ insert: '\n' });
                preview_editor.setContents($scope.n.terms)
            });
        }
    }).
    controller('quillController', function ($scope, $quillService) {
        var quillEditor = $quillService.createInstance('#editor-container', '#toolbar-container');
        $quillService.editorCreated(quillEditor);
    }).
    service('$quillService', function () {
        this.createInstance = (editorElement, toolbarElement) => {
        ...
        this.editorCreated = (quillEditor) => {
            this.onEditorCreated(quillEditor);
        }
    }).
